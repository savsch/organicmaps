...
public class InsecureHttpsHelper
{
  ...
  private static final TrustManager[] INSECURE_TRUST_MANAGERS = new TrustManager[]{new X509TrustManager()
  {
   ...
   */
  public static HttpURLConnection openInsecureConnection(String urlString) throws IOException, NoSuchAlgorithmException, KeyManagementException
  {
