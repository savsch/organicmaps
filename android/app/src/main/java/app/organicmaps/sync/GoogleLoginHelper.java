...
public class GoogleLoginHelper
{
  ...
  public static void login(Context context)
  {
    ...
    AuthorizationRequest.Builder builder = new AuthorizationRequest.Builder(
        ...
        "215362850630-l9j0opuu675mu14ri7b9mnsi28nroh2e.apps.googleusercontent.com",   // TODO use the real one instead
        ResponseTypeValues.CODE,
        Uri.parse(BuildConfig.APPLICATION_ID + ":" + GOOGLE_OAUTH_REDIRECT_PATH))
        .setCodeVerifier(codeVerifier,
            codeChallenge,
            "S256");
    // Two scopes in use:
    //   1. drive.file (see https://developers.google.com/workspace/drive/api/guides/api-specific-auth)
    //   2. email (used for showing user-facing profile name and for recognizing attempts to connect the same account twice)
    ...
    AuthorizationService service = new AuthorizationService(context, appAuthConfiguration); // this must be manually disposed
